...
namespace Template.Services
{
    public interface ITokenStoreService
    {
        ...
        Task<TokenResource> CreateJwtTokens(User user, string refreshTokenSource);
    ...
    public class TokenStoreService : ITokenStoreService
    {
        ...
        public async Task<TokenResource> CreateJwtTokens(User user, string refreshTokenSource)
        {
            ...
            return new TokenResource { AccessToken = accessToken, RefreshToken = refreshToken };
        }
